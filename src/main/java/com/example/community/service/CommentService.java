...
public class CommentService implements CommunityConstant {
    ...
    public int countComment(int entityType,int entityId){
        return commentMapper.countComment(entityType,entityId);
    }
    ...
    public int addComment(Comment comment){
        ...
        if(comment.getEntityType()==ENTITY_TYPE_POST){
            int count = commentMapper.countComment(comment.getEntityType(), comment.getEntityId());
            discussPostMapper.updateComment(comment.getEntityId(),count);
        }
