...
public class RedisKeyUtil {
    ...
    private static final String PREFIX_ENTITY_LIKE="like:entity";     //帖子实体获赞
    private static final String PREFIX_USER_LIKE="like:user";        //用户获赞数
    ...
    //某个用户的赞
    public static String geteUserLikeKey(int userId){
