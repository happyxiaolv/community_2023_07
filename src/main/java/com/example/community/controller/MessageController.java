...
//        System.out.println("布尔值结果:"+ids!=null);
    ...
    //获取target conversationid : from _ to
    ...
    public String sendLetter(String toName,String content){
        ...
        if(target==null){
            return CommunityUtil.getJSONString("目标用户不存在",1);
        }
    ...
    public String getNoticeList(Model model){
        ...
        if(message!=null){
            ...
            //将Message表  中包含转移字符的&qolt 转为正常符号
            String content= HtmlUtils.htmlUnescape(message.getContent());
            //将JSON数据转化为 对象,这里因为之前封装的为map集合
